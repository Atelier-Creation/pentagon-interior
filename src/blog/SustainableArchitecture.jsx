...
export default function SustainableArchitecture() {
  ...
  const currentPost = content.blogs.find(b => b.path === "/blog/architecture") || content.blogs[2];
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="text-gray-600 leading-7 mb-6 mt-10">
            {currentPost.title} explores the future of urban development, focusing on buildings that are environmentally responsible and resource-efficient throughout their life-cycle.
          </p>
          ...
          <p className="text-gray-600 mb-4 leading-7">
            The use of sustainable materials like cross-laminated timber, recycled steel, and low-carbon concrete is revolutionizing the industry.
          </p>
          <ul className="space-y-3 text-gray-600 mb-8">
            {["Utilize recycled and renewable resources.", "Choose materials with low embodied energy.", "Prioritize non-toxic and natural finishes."].map((item, i) => (
          ...
          <p className="text-gray-600 mb-4 leading-7">
            Maximize energy savings through passive solar heating, natural ventilation, and superior insulation.
          </p>
          <ul className="space-y-3 text-gray-600 mb-8">
            {["Optimize building orientation for solar gain.", "Incorporate high-performance windows.", "Design for natural airflow and daylighting."].map((item, i) => (
              <li key={i} className="flex items-start gap-3">
                <CheckCircle2 size={16} className="mt-1 text-[#8c6d5a]" />
                {item}
              </li>
            ...
            <div className="relative flex flex-col sm:flex-row items-center gap-4 md:gap-6 p-10 text-center sm:text-left text-white">
              ...
              <div>
                <p className="text-xl md:text-2xl font-semibold leading-relaxed">
                  Architecture should be a celebration of nature, not a conquest over it.
                </p>
          ...
          <p className="text-gray-600 mb-6 leading-7">
            Buildings are becoming power plants, generating their own clean energy through solar panels, wind turbines, and geothermal systems.
          </p>
          <div className="space-y-6 mb-10">
            {[
              { title: "Solar Power", desc: "Harnessing the sun's energy with integrated photovoltaic systems." },
              { title: "Water Conservation", desc: "Implementing greywater recycling and rainwater harvesting." },
              { title: "Smart Grids", desc: "Connecting buildings to intelligent energy management networks." }
            ].map((item, i) => (
          ...
          <p className="text-gray-600 mb-6 leading-7">
            Sustainable architecture is essential for creating resilient and livable cities for future generations.
          </p>
          <ul className="space-y-4 text-gray-600 mb-10">
            {["Design for longevity and adaptability.", "Foster a deep connection between occupants and the environment.", "Embrace innovation to solve complex environmental challenges."].map((item, i) => (
              <li key={i} className="flex items-start gap-3">
