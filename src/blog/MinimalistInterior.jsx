...
export default function MinimalistInterior() {
  const [hoveredIndex, setHoveredIndex] = useState(null);
  const [mousePos, setMousePos] = useState({ x: 0, y: 0 });
  const sidebar = content.blogSidebar;
  const currentPost = content.blogs.find(b => b.path === "/blog/minimalist-interior") || content.blogs[1];
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="text-gray-600 leading-7 mb-6 mt-10">
            {currentPost.title} focuses on simplicity, clean lines, and a monochromatic palette. It’s about creating a sense of freedom and calm in your living environment.
          </p>
