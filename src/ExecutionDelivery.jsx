...
>
          ...
          {/* CONTENT (ALWAYS OPEN FIRST LIKE IMAGE) */}
          {activeIndex === i && (
            <div className="px-8 pb-8">

              <div className="bg-white rounded-[18px] p-6 flex gap-6 items-center">
                ...
                <div className="flex-1">
                  <p className="text-[#6b7280] leading-[1.8] mb-5">
                    {item.desc}
                  </p>
