      ...
      >
        ...
        <div className="relative text-center max-w-3xl px-4">
          <p className="flex justify-center items-center gap-2 text-sm mb-4 opacity-90">
            <Calendar size={16} /> December 8, 2025
          </p>

          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            Innovative Lighting Ideas For Every Home
          </h1>
          ...
          <div className="flex justify-center gap-6 mt-4 text-sm opacity-80">
            ...
            <span className="flex items-center gap-1">
              <Eye size={16} /> 20 Views
            </span>
            <span className="flex items-center gap-1">
              <ThumbsUp size={16} /> 0 Likes
            </span>
          </div>
        </div>
      </section>
...
<Share2 size={18} strokeWidth={1.5} className="text-gray-400" />
    ...
    {/* ICON BUTTONS */}
    <div className="flex gap-4">
  {[Globe, Send, MessageCircle, Link, Mail].map(
    (Icon, i) => (
      <div
        key={i}
...
<div className="mt-14 bg-[#eef3ef] p-8 md:p-10 rounded-3xl">
  ...
  {/* BUTTON */}
  <button className="bg-[#8c6d5a] text-white px-8 py-3 rounded-full font-medium hover:opacity-90 transition">
    Post comment
  </button>
