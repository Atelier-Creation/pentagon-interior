...
>
  {/* DARK GREEN OVERLAY */}
  <div className="absolute inset-0 bg-[#2f4638]/90"></div>
  ...
  <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 items-center px-6">
    ...
    <div className="text-white max-w-xl">
      ...
      <div className="space-y-4 mb-10">
        ...
        <div className="flex justify-between border-b border-white/20 pb-3 text-gray-300">
...
>
      ...
      <div className="relative group overflow-hidden rounded-t-3xl">
          ...
          />
          {/* GREEN HOVER OVERLAY */}
<div className="absolute inset-0 bg-[#2f4638] text-white flex flex-col items-center justify-center 
opacity-0 group-hover:opacity-100 transition duration-300 rounded-t-3xl">
  ...
  <div className="flex gap-4 mt-4 text-lg">
    ...
    <span className="cursor-pointer hover:scale-110">𝕏</span>
          ...
          {/* CURVE OVERLAY */}
<div className="absolute bottom-0 w-full bg-[#eef2ef] rounded-t-[120px] pt-10 pb-6 text-center 
